...
namespace BD_Assessment_WebAPI_Ruan_Gates.Migrations
{
    ...
    [Migration("20200417142356_Adding Batch and Number input reference to batch collection table")]
    partial class AddingBatchandNumberinputreferencetobatchcollectiontable
    {
